...
import { User, Phone, CreditCard, Mail, Lock } from 'lucide-react';
import Dropdown from './Dropdown.jsx';

export default function FormUser({ onSubmit, initialData }) {
    ...
    return (
        <form id="form-user" onSubmit={handleSubmit} className="p-4 md:px-6 md:py-6 space-y-4 md:space-y-6">
            <div>
